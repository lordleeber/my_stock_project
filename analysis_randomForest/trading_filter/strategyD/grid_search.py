...
from analysis_randomForest.trading_filter.multi_strategy_backtest import (  # noqa: E402
    build_position_size,
    check_entry_allowed,
    normalize_quotes,
)
...
def simulate_one_partial(
    ...
    for i, day in q.iterrows():
        ...
        # 第二階段: 已先落袋一部分，剩下用 trailing stop / tp2 / time stop
