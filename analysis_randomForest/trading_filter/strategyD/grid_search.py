...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="strategyD: partial take profit + trailing stop grid search")
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("analysis_randomForest/trading_filter/strategyD"))
...
def main() -> None:
    ...
    print("strategyD skeleton ready")
    print(f"- candidates: {args.candidates}")
    print(f"- quotes-cache: {args.quotes_cache}")
    print(f"- output-dir: {args.output_dir}")
    print("TODO: implement partial-exit simulation and grid search")
