...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="strategyH: portfolio-level risk control grid search")
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("analysis_randomForest/trading_filter/strategyH"))
...
def main() -> None:
    ...
    print("strategyH skeleton ready")
    print(f"- candidates: {args.candidates}")
    print(f"- quotes-cache: {args.quotes_cache}")
    print(f"- output-dir: {args.output_dir}")
    print("TODO: implement portfolio-level constraints and grid search")
