...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="strategyE: volatility-adjusted TP/SL grid search")
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("analysis_randomForest/trading_filter/strategyE"))
...
def main() -> None:
    ...
    print("strategyE skeleton ready")
    print(f"- candidates: {args.candidates}")
    print(f"- quotes-cache: {args.quotes_cache}")
    print(f"- output-dir: {args.output_dir}")
    print("TODO: implement volatility/ATR based exit rules and grid search")
