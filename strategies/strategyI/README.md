...
## 檔案
- `strategies/strategyI/grid_search.py`

## 執行方式
```powershell
.\.venv\Scripts\python.exe strategies/strategyI/grid_search.py
```

## 輸出
- `strategies/strategyI/grid_results_all.csv`
- `strategies/strategyI/grid_results_top20.csv`
- `strategies/strategyI/best_config.json`
