...
NUMERIC_COLS = [
    ...
    "last_disclosed_bid",
    "last_disclosed_ask",
    "last_disclosed_bid_volume",
    "last_disclosed_ask_volume",
    "next_day_upper_limit",
    "next_day_lower_limit",
    "pe_ratio",
    "dividend_yield",
    "dividend_per_share",
    "pb_ratio",
...
SCHEMA_COLS = {
    ...
    "income_statement": [
        ...
        "gross_profit_acc",
        "operating_expense_q",
        "operating_expense_acc",
        "operating_income_q",
        "operating_income_acc",
        "non_operating_income_q",
        "non_operating_income_acc",
        "pretax_income_q",
        "pretax_income_acc",
        "tax_expense_q",
        "tax_expense_acc",
        "net_income_q",
        "net_income_acc",
        "other_comprehensive_income_q",
        "other_comprehensive_income_acc",
        "comprehensive_income_q",
        "comprehensive_income_acc",
        "eps_q",
        "eps_acc",
        "net_interest_income_q",
        "net_interest_income_acc",
        "non_interest_income_q",
        "non_interest_income_acc",
        "net_revenue_q",
        "net_revenue_acc",
        "other_income_net_q",
        "other_income_net_acc",
        "pced_file",
        "pced_row",
        "pced_col",
    ],
    ...
    "cash_flow": [
        ...
        "name",
        "statement_type",
        "cash_flow_operating_q",
        "cash_flow_operating_acc",
        "cash_flow_investing_q",
        "cash_flow_investing_acc",
        "cash_flow_financing_q",
        "cash_flow_financing_acc",
        "fx_effect_q",
        "fx_effect_acc",
        "net_cash_change_q",
        "net_cash_change_acc",
    ...
    "stock_tags": ["symbol", "tag", "pced_file", "pced_row", "pced_col"],
    "dividend": [
        "date",
        "symbol",
        "name",
