...
# v9_t1: 8/15 視角 + 月營收特徵工程（同比 + 產業標準化）
FEATURES = [
    "q2_eps",
    "ly_q3_eps",
    "q2_margin",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Prepare v9_t1 dataset for analysis_codex from DB.")
...
def main() -> None:
    ...
    with engine.connect() as conn:
        ...
        for year in range(args.start_year, args.end_year + 1):
            print(f"fetching v9_t1 data: year={year}, market={args.market}")
    ...
    print("v9_t1 prepare_data completed")
