...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Backtest for analysis/v9_t1")
...
def main() -> None:
    ...
    for test_year in years[1:]:
        ...
        val = build_valuation_daily_frame(test_df, pred_eps_lgb, f"lgb_v9_t1_{args.feature_transform}", "analysis_LightGBM/v9/t1/results/predictions.csv")
    ...
    print("v9_t1 backtest completed")
    print(f"- {fold_path}")
