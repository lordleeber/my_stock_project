...
# 7/15 閬? -> anchor_eps=Q1EPS + 4/5/6???塚??怠?瘥??Ｘ平璅???
FEATURES = [
    "anchor_eps",
    "ly_q2_eps",
    "q1_yoy_eps",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Prepare v10 dataset (7??閫? from DB or API.")
...
def main() -> None:
    ...
    # 7 ??閫??賭蝙?典歇?砍???Q1 ??閮??踹??撟?Q2嚗?砍?嚗葆?仿?瘣拇?
