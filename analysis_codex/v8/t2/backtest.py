...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Backtest for analysis/v8_t2")
...
def main() -> None:
    ...
    for test_year in test_years:
        ...
        val_df = build_valuation_daily_frame(
            ...
            model_version="v8_t2",
            source_file="analysis_codex/v8/t2/results/predictions.csv",
        )
    ...
    print("v8_t2 backtest completed")
    print(f"- {fold_path}")
    print(f"- {pred_path}")
