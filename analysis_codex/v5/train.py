...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train v5 model for analysis_codex.")
...
def main() -> None:
    ...
    # v5.1: 對特徵與目標增量做 winsorize，降低極端值影響
    winsorize_inplace(df, FEATURES + [TARGET_DELTA], args.winsor_quantile)
