...
KEEP_OPTIONAL = ["symbol", "name", "q2_rev", "rev_m7", "rev_m8", "rev_m9"]

PROJECT_ROOT = Path(__file__).resolve().parents[2]
DEFAULT_SOURCE = PROJECT_ROOT / "analysis" / "v2" / "dataset.csv"
DEFAULT_OUTPUT = Path(__file__).resolve().parent / "dataset.csv"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Prepare v2 dataset for analysis_codex.")
