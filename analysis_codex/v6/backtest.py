...
def main() -> None:
    ...
    for test_year in test_years:
        ...
        keep_cols = [c for c in ["year", "symbol", "name", "q3_date", "q3_close", "pe_current", "ttm_eps_official"] if c in test_df.columns]
        ...
        val_df = build_valuation_daily_frame(
            ...
            model_version="v6",
            source_file="analysis_codex/v6/results/predictions.csv",
        )
