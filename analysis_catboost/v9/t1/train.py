...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train v9_t1 model for analysis_codex.")
...
def main() -> None:
    ...
    metrics = {
        ...
        "train_mae_cat_pred_eps": float(mean_absolute_error(y_true, pred_eps)),
