...
# v9_t3: 10月初視角 -> Q2 + 7/8/9月，含同比與產業標準化
FEATURES = [
    "q2_eps",
    "ly_q3_eps",
    "q2_margin",
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Prepare v9_t3 dataset for analysis_codex from DB.")
...
def main() -> None:
    ...
    with engine.connect() as conn:
        ...
        for year in range(args.start_year, args.end_year + 1):
            print(f"fetching v9_t3 data: year={year}, market={args.market}")
    ...
    print("v9_t3 prepare_data completed")
